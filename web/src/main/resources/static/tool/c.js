window.SINGLE_TAB = "  ";
window.ImgCollapsed = "./static/js/tool/Collapsed.gif";
window.ImgExpanded = "./static/js/tool/Expanded.gif";
...
function CollapsibleViewClicked(res) {

    $id("CollapsibleViewDetail").style.visibility = res ? "visible" : "hidden";
...
function QuoteKeysClicked(ced) {
    window.QuoteKeys = ced;
    Process();
